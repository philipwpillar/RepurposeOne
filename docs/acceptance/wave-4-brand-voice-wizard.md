...
6. Wizard drafts are free and do not consume monthly generation credits. To avoid inventing a billing surface, authenticated users are limited to five draft attempts in a rolling 24-hour period. **Confirmed intentional:** this is a separate uncapped-cost surface from plan-tier generation credits; the 5/day cap plus fast-tier model is the accepted control for v1.
